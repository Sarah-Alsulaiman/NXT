 ...
 */
   public void processStarted(tern.nxt.rt.Process p) { }
   
   
   public void processStopped(tern.nxt.rt.Process p) { }

   
   public void trace(tern.nxt.rt.Process p, String message) {
      try {
   ...
   public void print(tern.nxt.rt.Process p, String message) {
      Log.i(TAG, message);
   ...
   public void error(tern.nxt.rt.Process p, String message) {
      Log.i(TAG, message);
      this.message = message;
      repaint();
   }
